...
"""Utilities intended for "running jobs" on toolkit, dgx, etc.

IN the scope of this file:
- Starting/managing jobs.
- Haven.
- Hyperparameter search.

OUT of this file's scope:
- Anything that you would still need if you had only one job to run.
"""
...
def dict_hash(dictionary: Dict[str, Any]) -> str:
    ...
    Why it is here: we use it to produce Haven experiment ids.
    """
    dhash = hashlib.md5()
