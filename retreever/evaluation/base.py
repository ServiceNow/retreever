...
class Metric:
    """Abstract base class for retrieval / generation metrics.

    Subclasses implement ``__call__(predictions, references, ...)`` to
    return a single float. Concrete metrics live in
    :mod:`retreever.evaluation.metrics`.
    """
